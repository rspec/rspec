RSpec.describe "a matcher defined using the matcher DSL" do
  ...
  it "warns when passing block to the block of define", :skip => (RUBY_VERSION.to_f < 1.9) do
...
module RSpec::Matchers::DSL
  ...
  RSpec.describe Matcher do
    ...
    context "defined using the dsl" do
      ...
      it 'can get a method object for methods in the running example', :skip => (RUBY_VERSION.to_f < 1.9) do
