...
* Add opt-in config option (`RSpec::Core::Configuration#strict_docstring!`) to raise an
  error when an example is described with anything but a string, or an example group with
  anything but a string, a class or a module. Enabled by default in the `spec/spec_helper.rb`
  generated by `rspec --init`.
  (Eisuke Yoshida, Phil Pirozhkov, rspec/rspec-core#3081, rspec/rspec#339)
